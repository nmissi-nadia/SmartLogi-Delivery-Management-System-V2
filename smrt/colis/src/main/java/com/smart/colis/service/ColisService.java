...
import com.smart.colis.src.main.java.com.smart.colis.mapper.ColisProduitMapper;
 ...
 */
    ...
    public Page<ColisDTO> findColisByLivreur(String livreurId, Pageable pageable) {
        log.debug("Récupération des colis pour le livreur: {}", livreurId);
   ...
   public boolean isLivreurOfColis(String colisId, String userId) {
    ...
    public boolean isClientOfColis(String colisId, String userId) {
        Colis colis = colisRepository.findById(colisId).orElse(null);
        return colis != null && 
            colis.getClientExpediteur() != null && 

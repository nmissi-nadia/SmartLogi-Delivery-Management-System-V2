...
public class LivreurController {
    ...
    @GetMapping
    @PreAuthorize("hasAuthority('MANAGE_LIVREURS')")
   ...
   @PostMapping
    ...
    @PreAuthorize("hasAuthority('UPDATE_COLIS_STATUS_LIVREUR') or hasAuthority('MANAGE_COLIS')")
    ...
    @GetMapping("/colis")
    @PreAuthorize("hasAuthority('VIEW_ASSIGNED_COLIS_LIVREUR') or hasAuthority('MANAGE_COLIS')")
    ...
    public ResponseEntity<Page<ColisDTO>> getColisAssignes(
        ...
        String livreurId = service.findByUsername(username).map(Livreur::getId).orElse(null);
